...
public class Client{
  ...
  public static void main(String argv[]) throws Exception
  {
    ...
    System.out.println();
    System.out.println(RTSP_server_port + " " +VideoFileName );
    System.out.println();
  ...
  private void send_RTSP_request(String request_type)
  {
    try{
      ...
      if(request_type.compareTo("SETUP")==0){
        RTSPBufferedWriter.write("TRANSPORT: RTP/UDP; client_port= 25000");
        System.out.println("TRANSPORT: RTP/UDP; client_port= 25000");
      }
      else{
        RTSPBufferedWriter.write("Session: 123456");
        System.out.println("Session: 123456");
      }
      RTSPBufferedWriter.newLine();
